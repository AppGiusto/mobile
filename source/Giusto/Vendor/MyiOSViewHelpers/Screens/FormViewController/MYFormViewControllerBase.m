...
- (void) addValidator:(ALPValidator*)validator forControl:(UIControl*)control
{
    ...
    __weak __typeof__(validator) weakValidator = validator;
    ...
    validator.validatorStateChangedHandler = ^(ALPValidatorState newState) {
        switch (newState) {
            ...
            case ALPValidatorValidationStateInvalid:
                ...
                [blockSelf.statusBarNotification displayNotificationWithMessage:weakValidator.errorMessages[0] completion:NULL];
