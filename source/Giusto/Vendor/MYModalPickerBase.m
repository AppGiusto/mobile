...
- (void)onCancel:(id)sender {
    ...
    if (self.callbackBlock) {
        self.callbackBlock((MYModalPickerView *)self,NO);
    } else if (self.dateCallbackBlock) {
        self.dateCallbackBlock((MYModalDatePickerView *)self,NO);
    }
...
- (void)onDone:(id)sender {
    ...
    if (self.callbackBlock) {
        self.callbackBlock((MYModalPickerView *)self,YES);
    } else if (self.dateCallbackBlock) {
        self.dateCallbackBlock((MYModalDatePickerView *)self,YES);
    }
